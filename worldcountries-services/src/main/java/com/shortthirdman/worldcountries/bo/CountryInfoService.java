...
public class CountryInfoService {
	...
	public List<CountryInfoDetail> getCountriesByDrivingSide(String side) throws Exception {
		Collection<CountryInfo> entities = repository.getCountriesByDrivingSide(side);
		return entities.stream().map(c -> processor(c)).collect(Collectors.toList());
	}
